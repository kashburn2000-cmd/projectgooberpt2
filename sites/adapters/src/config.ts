...
export const SITE = {
  ...
  SITE_URL: "https://voltroam.com",
  /** Public contact address (trust pages, JSON-LD, ads.txt owner). */
  CONTACT_EMAIL: "hello@voltroam.com",
  /**
...
export const SITE_TAGLINE =
  "Know exactly which travel plug adapter and voltage converter you need — for any country, for your trip.";

/** Brand color (kept in sync with the CSS theme in styles/global.css). */
export const THEME_COLOR = "#0b6bcb";
