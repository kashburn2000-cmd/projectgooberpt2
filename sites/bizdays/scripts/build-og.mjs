...
function card({ title, subtitle }) {
  return el(
    "div",
    {
      ...
      padding: 72,
      background: "linear-gradient(135deg, #0b0e1a 0%, #312e81 55%, #4f46e5 100%)",
    ...
    [
      ...
      el("div", { display: "flex", flexDirection: "column" }, [
        ...
        el("div", { display: "flex", fontSize: 32, color: "#c7d2fe", marginTop: 20 }, [text(subtitle)]),
      ]),
      // footer
      el("div", { display: "flex", justifyContent: "space-between", alignItems: "center" }, [
        el("div", { display: "flex", fontSize: 26, color: "#a5b4fc" }, [text(URL)]),
        el("div", { display: "flex", fontSize: 24, color: "#a5b4fc" }, [text("Business days · Public holidays")]),
      ]),
    ],
  );
}
...
const VARIANTS = [
  { file: "default", title: "Business day calculator", subtitle: "Working days & public holidays for 200+ countries" },
  { file: "holidays", title: "Public holidays by country", subtitle: "Every country's holiday dates, by year" },
  { file: "business", title: "Working days by country", subtitle: "Count business days, weekends & holidays included" },
  { file: "guide", title: "Business-day guides", subtitle: "Working days, net terms & holidays, explained" },
];
